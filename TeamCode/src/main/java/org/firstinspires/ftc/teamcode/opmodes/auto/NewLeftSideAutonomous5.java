...
@Config
@Autonomous(name = "NEW555LeftSideAutonomous5", group = "Autonomous")
public class NewLeftSideAutonomous5 extends LinearOpMode {
        ...
        */
        ...
        public class PlaceSampleSubmersible implements Action {
            ...
            public boolean run(@NonNull TelemetryPacket telemetryPacket) {
                ...
                if (slidesReachedTarget(2200, 60) && !wristPlaceSample) {
                    timer.reset();
                    claw.setPosition(clawOpen);
        ...
        public class GrabSample implements Action {
            ...
            public boolean run(@NonNull TelemetryPacket telemetryPacket) {
                ...
                if (slidesReachedTarget(730, 30) && !closeClaw && extendSlidesSample) {
                    timer.reset();
                    claw.setPosition(clawClose);
                    closeClaw = true;
                }

                if (closeClaw && timer.seconds() > 0.45) {
                    moveSlides(400, 1);
                    return false;
                }
        ...
        public class GrabSample4 implements Action {
            ...
            public boolean run(@NonNull TelemetryPacket telemetryPacket) {
                ...
                if (slidesReachedTarget(1020, 30) && !closeClaw && extendSlidesSample) {
                    timer.reset();
                    claw.setPosition(clawClose);
                    closeClaw = true;
                }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder grabSample2 = placeSample1.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(-46, -41), Math.toRadians(89.8));
        ...
        TrajectoryActionBuilder grabSample3 = placeSample2.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(-55.5 , -41), Math.toRadians(82));

        TrajectoryActionBuilder placeSample3 = grabSample3.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(-48.8, -48.8), Math.toRadians(45));
        ...
        TrajectoryActionBuilder placeSample4 = grabSample4.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(-49, -49), Math.toRadians(45));

        TrajectoryActionBuilder grabSample5 = placeSample4.endTrajectory().fresh()
                .setTangent(Math.toRadians(107))
                .splineToLinearHeading(new Pose2d(-17, -8, Math.toRadians(0)), Math.toRadians(0), new TranslationalVelConstraint(100))
                .waitSeconds(1);
        ...
        double grabSample5Pose = -8+armslidesclaw.realXtoMM();

        TrajectoryActionBuilder alignRobot = grabSample5.endTrajectory().fresh()
                .setTangent(Math.toRadians(90))
                .lineToY(grabSample5Pose);
        ...
        TrajectoryActionBuilder placeSample5 = alignRobot.endTrajectory().fresh()
                ...
                .splineToLinearHeading(new Pose2d(-49.2, -44.8, Math.toRadians(48)), Math.toRadians(270), new TranslationalVelConstraint(150));

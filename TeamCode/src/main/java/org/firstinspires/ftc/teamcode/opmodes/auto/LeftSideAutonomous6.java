...
@Config
@Autonomous(name = "LeftSideAutonomous6", group = "Autonomous")
public class LeftSideAutonomous6 extends LinearOpMode {
        ...
        */
        ...
        public class GrabSample implements Action {
            ...
            public boolean run(@NonNull TelemetryPacket telemetryPacket) {
                ...
                if (slidesReachedTarget(770, 30) && !closeClaw && extendSlidesSample) {
                    timer.reset();
                    claw.setPosition(clawClose);
                    closeClaw = true;
                }
        ...
        public class GrabSample4 implements Action {
            ...
            public boolean run(@NonNull TelemetryPacket telemetryPacket) {
                ...
                if (slidesReachedTarget(1100, 30) && !closeClaw && extendSlidesSample) {
                    timer.reset();
                    claw.setPosition(clawClose);
                    closeClaw = true;
                }

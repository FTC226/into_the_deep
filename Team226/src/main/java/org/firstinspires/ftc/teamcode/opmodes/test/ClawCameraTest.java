...
public class ClawCameraTest extends OpMode {
    ...
    public void loop(){
        ...
        try {
            ...
            telemetry.addData("DELTA X ", pipeline.deltax);
            telemetry.addData("DELTA Y", pipeline.deltay);
    ...
    class ColorDetectionPipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {//Object Detection
            ...
            if (redRect != null) {
                ...
                angle = calculateAngle(redRect.width);
                deltax = redRect.width;
                deltay = redRect.height;
            }
            ...
            if (yellowRect != null) {
                ...
                angle = calculateAngle(yellowRect.width);
                deltax = yellowRect.width;
                deltay = yellowRect.height;
            }
            ...
            if (blueRect != null) {
                ...
                angle = calculateAngle(blueRect.width);
                deltax = blueRect.width;
                deltay = blueRect.height;
            }
        ...
        private double calculateDistance(double objectHeightInPixels) {
            double KNOWN_OBJECT_HEIGHT = 1.5;
            double FOCAL_LENGTH = 0.5769;
            return (KNOWN_OBJECT_HEIGHT * FOCAL_LENGTH) / objectHeightInPixels;
        }

        private double calculateAngle(double objectLengthInPixels){
            double KNOWN_OBJECT_LENGTH = 3.5;
            double FOCAL_LENGTH = 345;
            double SMALL_PIXEL_ANGLE = 50;
            double BIG_PIXEL_ANGLE = SMALL_PIXEL_ANGLE*2;
            return 72 * objectLengthInPixels - 80.357;
        }
